...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const descarr = [
            ...
            '<:LYG_OkayuBOOM:1138231827140706304> **Util Commands** (Số Lệnh Hiện Có: 1)**\n\n**• /announcement**\nCấu Trúc Lệnh: `/announcement [channel] [title] [message] [imglink]`\nGửi Thông Báo Cho Toàn Server Biết\nTrong Đó: `[channel]` (Bắt Buộc): Kênh Để Gửi Thông Báo, `[title]` (Bắt Buộc): Tiêu Đề Của Thông Báo, `[message]` (Bắt Buộc): Nội Dung Để Gửi Thông Báo, `[imglink]` (Không Bắt Buộc): Link Ảnh Đi Kèm Cho Thông Báo'
        ]
        const colorarr = [
            '#EFFFB3',
            '#F6B3FF',
