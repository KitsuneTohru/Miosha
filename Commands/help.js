...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const descarr = [
            ...
            '<:LYG_Error:1087366990160740452> **Misc Commands** (Số Lệnh Hiện Có: 2)\n\n> **• /test**\nCấu Trúc Lệnh: `/test` (TESTER ONLY)\nCD: [___]\nCâu Lệnh Này Chỉ Dùng Để Test Một Số Chức Năng Từ Chủ Bot Thôi\n\n> **•/numconv**\nCấu Trúc Lệnh `/numconv [number]`\nCD: 10 Giây\nQuy Đổi Số Sang Các Hệ Cơ Số Khác Nhau (DEC/HEX/BIN)/OCT\nTrong Đó: `[number]` (Bắt Buộc): `(``12345`,`ABCDEF`,`10011001``)`\nLƯU Ý: Hệ OCT Chỉ Có Ở Output, Do Bị Trùng Kiểu Khi Duyệt Như Dec Nên Ko Xét Vô Input Được',
