...
module.exports = {
    ...
    async execute(interaction) {
        const date = new Date().setTime(1679762100000)
        const embed = new EmbedBuilder()
            ...
            .setDescription('<:LYG_FubukiPing1:1084085915368050788> **Phiên Bản:** `[LYG]` v.0.5.0/`[Game Over]` v.0.3.5: Update Lệnh `/omikuji`, Thêm Lệnh `/help`\n<a:LYG_OkayuLove:1087692048280334347> Special Thanks For: <@963815526176546836> (Idea Average Cho Con Bot Này!)\n<a:LYG_Clock:1084322030331105370> **Last Update:** <t:1679762100> (<t:1679762100:R>)')
