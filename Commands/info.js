...
module.exports = {
    ...
    async execute(interaction) {
        const date = new Date().setTime(1679325300000)
        const embed = new EmbedBuilder()
            ...
            .setDescription('<:LYG_FubukiPing1:1084085915368050788> **Phiên Bản:** `[LYG]` v.0.4/`[Game Over]` v.0.2 Cooldown Đang Bị Issue, Nhưng Đã Add Lệnh `\howgay`!\n<a:LYG_Clock:1084322030331105370> **Last Update:** <t:1679325300> (<t:1679325300:R>)')
