...
module.exports = {
    ...
    async execute(interaction) {
        const date = new Date().setTime(1678553100000)
        const embed = new EmbedBuilder()
            ...
            .setDescription('**[LYG] v.0.2/[Game Over] v.0.1.2** Đã Add Vài Lệnh!!!\nAsset Các Lệnh Này Từ Bot Bên `Game Over` (Cre To: **<@809259609700302935>**), Thực Chất **__GẦN NHƯ TOÀN BỘ__** Entry Ở Thẻ + Thuật Toán Là Từ **<@751225225047179324>** Nhé\n**Last Update:** <t:1678553100> (<t:1678553100:R>)')
