...
module.exports = {
    ...
    async execute(interaction) {
        const date = new Date().setTime(1679844000000)
        const embed = new EmbedBuilder()
            ...
            .setDescription('<:LYG_FubukiPing1:1084085915368050788> **Phiên Bản:** `[LYG]` v.0.5.2/`[Game Over]` v.0.3.7: Update Lệnh `/avatar``\n<a:LYG_Clock:1084322030331105370> **Last Update:** <t:1679844000> (<t:1679844000:R>)')
